# -*- coding: utf-8 -*-
"""
eval_idea3_reviser_7b_Dailyomni_human+reviser+grounder.py
Daily-omni ablation pipeline for GRPO_Grounder + HumanOmni + Reviser.
Pipeline: GRPO_Grounder -> HumanOmniV2 (REINFORCE) -> Reviser
"""
...
def main():
    ...
    print("[INFO] Running ablation pipeline: GRPO_Grounder -> HumanOmniV2 -> Reviser")
    ignored_args = {
